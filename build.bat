...
echo.
echo Usage examples:
echo   AMSIBypass.exe -f bypass.txt      # Save to file
echo   AMSIBypass.exe -b                 # Test until bypass found (display only
echo   AMSIBypass.exe -b -i              # Test and inject bypass into new PowerShell
echo.
echo ========================================================================
echo.
